...
; Creates AuspHex window and runs HexVision
{
	...
	contrastViewIcon := AuspHexWindow.Add("Text", Format("X+{} YP W{} H{} Background{} c{} +0x0100 +0x200 Center", contrastView_padding, largeLineHeight, largeLineHeight, defaultBackground, defaultForeground), "📊") ; 0x200 centers text vertically; 0x0100 lets this accept a tooltip
